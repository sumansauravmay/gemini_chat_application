...
// const GEMINI_API_KEY ="AIzaSyC_H1z7YzxzI1A9_CW518Y_qzGebFYNNUY" || process.env.GEMINI_API_KEY;
...
// async function getGeminiReply(userMessage="hello, my name is Suman") {
